...
function setupProcessObject() {
  ...
  Object.setPrototypeOf(origProcProto, EventEmitter.prototype); // 将 process.__proto__ 设置为 EventEmitter 的实例（也就是看到的第一次event断点￣へ￣）
...
// getter，主进程不能修改process.stdio，只能fork之后pipe，或者修改stdio._write方法
